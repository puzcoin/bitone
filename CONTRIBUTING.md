Contributing to Bone Core
============================

The Bone Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bone Core project, and is not to be
confused with overall Bone Network Protocol consensus changes.

Whether a pull request is merged into Bone Core rests with the project merge
...
Patches that change Bone consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bone consensus, it must have been
...
The project leader is the release manager for each Bone Core release.
