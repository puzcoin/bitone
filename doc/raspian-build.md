Bitone build instructions for Raspian
======================================
To build bitone the following packages need to be installed on the system:
---------------------------------------------------------------------------
...
Download the bitone sourcecode from github
-------------------------------------------

git clone https://github.com/cevap/bone.git -b master --depth=1

Build the bitone package
-------------------------
cd bone  
./autogen.sh  
...
Enter a name such as Bitone in this example
