...
In order to support loading of multiple wallets in bone-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bone.cpp.
...
Changes to bone.cpp
----------------------
bone.cpp is the entry point into bone-qt, and as such, will require some minor modifications to provide hooks for
