...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bone features */
        {"bone", "masternode", &masternode, true, true, false},
        {"bone", "listmasternodes", &listmasternodes, true, true, false},
        {"bone", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bone", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bone", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bone", "masternodedebug", &masternodedebug, true, true, false},
        {"bone", "startmasternode", &startmasternode, true, true, false},
        {"bone", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bone", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bone", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bone", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bone", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bone", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bone", "mnbudget", &mnbudget, true, true, false},
        {"bone", "preparebudget", &preparebudget, true, true, false},
        {"bone", "submitbudget", &submitbudget, true, true, false},
        {"bone", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bone", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bone", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bone", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bone", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bone", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bone", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bone", "checkbudgets", &checkbudgets, true, true, false},
        {"bone", "mnsync", &mnsync, true, true, false},
        {"bone", "spork", &spork, true, true, false},
        {"bone", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bone", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> bone-cli " + methodname + " " + args + "\n";
}
