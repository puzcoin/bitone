...
/* bone GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BONE"
#define QAPP_ORG_DOMAIN "bone-coin.com"
#define QAPP_APP_NAME_DEFAULT "Bone-Qt"
#define QAPP_APP_NAME_TESTNET "Bone-Qt-testnet"
