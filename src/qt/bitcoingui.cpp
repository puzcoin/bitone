                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bone Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bone address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bone: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for xBONE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bone Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bone Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BONE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bone addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bone addresses"));
    ...
    openAction->setStatusTip(tr("Open a BONE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bone Core help message to get a list with possible Bone command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bone Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bone network", "", count));
}
...
{
    QString strTitle = tr("Bone Core"); // default title
