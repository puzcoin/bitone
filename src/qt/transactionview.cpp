 ...
 */
    ...
    typeWidget->addItem(tr("Received Bone from xBONE"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in xBONE"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_xBONE));
