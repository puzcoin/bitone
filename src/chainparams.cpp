...
public:
    CMainParams()
    {
        ...
        nLastPOWBlock = 200;                         // PoW Phase 3 End
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "BitONE.cash : 'Transaction As A Miner'";
        genesis.nTime = 1546940985;                                         // GMT: Thursday, February 2, 2017 2:30:00 PM
...
*/
	...
	vSeeds.push_back(CDNSSeedData("node1", "node1.bonecash.com"));
        vSeeds.push_back(CDNSSeedData("node2", "node2.bonecash.com"));
        vSeeds.push_back(CDNSSeedData("node3", "node3.bonecash.com"));
        ...
        strObfuscationPoolDummyAddress = "BitoneDarksendPoo1DummyAdy4viSr";
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("1", "testnet.seeder.baseserv.com")); // Bone's official testseed 1
        vSeeds.push_back(CDNSSeedData("2", "testnet.seeder.uksafedns.net")); // Bone's official testseed 2
        // Testnet Bone addresses start with 'g'
...
public:
    CRegTestParams()
    {
        ...
        genesis.nNonce = 0x496f6e;                // hex 57 47 52 in text = BONE
