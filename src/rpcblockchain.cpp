...
/*
    ...
    result.push_back(Pair("xBONEsupply", xionObj));
*/
    return result;
}
...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in bone\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of bone addresses\n"
            "     \"boneaddress\"   	 	(string) bone address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
