...
This means one can have an always-on boned instance running, and another local boned/bone-qt instance which connects to this node and receives blocks from it.
