...
RESOURCES += src/qt/bone.qrc src/qt/bone_locale.qrc

TRANSLATIONS += src/qt/locale/bone_bg.ts \
                src/qt/locale/bone_de.ts \
                src/qt/locale/bone_en.ts \
                src/qt/locale/bone_es.ts \
                src/qt/locale/bone_fi.ts \
                src/qt/locale/bone_fr.ts \
                src/qt/locale/bone_it.ts \
                src/qt/locale/bone_ja.ts \
                src/qt/locale/bone_pl.ts \
                src/qt/locale/bone_pt.ts \
                src/qt/locale/bone_ru.ts \
                src/qt/locale/bone_sk.ts \
                src/qt/locale/bone_sv.ts \
                src/qt/locale/bone_vi.ts \
                src/qt/locale/bone_zh_CN.ts \
                src/qt/locale/bone_zh_TW.ts
