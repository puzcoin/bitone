...
#   c) node1 mines 32 blocks, so now node 0 has 60001bone, node 1 has 4250bone, node2 has none.
#   d) node0 sends 601 bone to node2, in two transactions (301 bone, then 300 bone).
